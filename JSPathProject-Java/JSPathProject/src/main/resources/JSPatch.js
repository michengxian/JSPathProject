...
;(function() {
  ...
  console.log('JS================-0'+methodName);
      ...
      if (clsName && _ocCls[clsName]) {
        ...
        if (_ocCls[clsName][methodType][methodName]) {
          slf.__isSuper = 0;
  console.log('JS================-2'+clsName+' methodType:'+methodType+' methodName:'+methodName);
  ...
  console.log('JS================-4'+slf.__clsName+' slf.__obj:'+slf.__obj);
